...
void __CAMERA_SET_ANGLE(){
  ...
  // offset
  int _after_offset_ang = camera_angle;
  // _after_offset_ang -= 90;

  _after_offset_ang = (_after_offset_ang%360+360)%360;
  __HAL_TIM_SetCompare(&htim11,TIM_CHANNEL_1,(int)(500.0+(double)(_after_offset_ang)*2500.0/360.0) );	  
}
