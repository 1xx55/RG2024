...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM4_MspPostInit 0 */
    ...
    PD12     ------> TIM4_CH1
    */
    GPIO_InitStruct.Pin = MSDriver_PUL_L_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM4;
    HAL_GPIO_Init(MSDriver_PUL_L_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM8_MspPostInit 0 */
    ...
    PC7     ------> TIM8_CH2
    */
    GPIO_InitStruct.Pin = MCL_LEFT_Pin|MCL_RIGHT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM13_MspPostInit 0 */
    ...
    PF8     ------> TIM13_CH1
    */
    GPIO_InitStruct.Pin = FIX_POS_DJ_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF9_TIM13;
    HAL_GPIO_Init(FIX_POS_DJ_GPIO_Port, &GPIO_InitStruct);
