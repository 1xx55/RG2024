...
#define Pin_Exti_HallEncoderA2_Pin GPIO_PIN_13
#define Pin_Exti_HallEncoderA2_GPIO_Port GPIOC
#define Pin_Exti_HallEncoderA2_EXTI_IRQn EXTI15_10_IRQn
#define Pin_PullDown_HallEncoderB2_Pin GPIO_PIN_2
#define Pin_PullDown_HallEncoderB2_GPIO_Port GPIOF
#define Pin_Exti_HallEncoderA1_Pin GPIO_PIN_3
#define Pin_Exti_HallEncoderA1_GPIO_Port GPIOF
#define Pin_Exti_HallEncoderA1_EXTI_IRQn EXTI3_IRQn
...
#define MCL_LEFT_Pin GPIO_PIN_6
#define MCL_LEFT_GPIO_Port GPIOC
#define MCL_RIGHT_Pin GPIO_PIN_7
#define MCL_RIGHT_GPIO_Port GPIOC
#define MCL_GND2_Pin GPIO_PIN_8
#define MCL_GND2_GPIO_Port GPIOC
#define MCL_GND1_Pin GPIO_PIN_9
#define MCL_GND1_GPIO_Port GPIOC
#define B_ENA1_Pin GPIO_PIN_6
#define B_ENA1_GPIO_Port GPIOD
#define B_ENA2_Pin GPIO_PIN_7
#define B_ENA2_GPIO_Port GPIOD
#define B_INA1_Pin GPIO_PIN_9
#define B_INA1_GPIO_Port GPIOG
#define B_INA2_Pin GPIO_PIN_10
#define B_INA2_GPIO_Port GPIOG
#define B_INB1_Pin GPIO_PIN_11
#define B_INB1_GPIO_Port GPIOG
#define B_INB2_Pin GPIO_PIN_12
#define B_INB2_GPIO_Port GPIOG
...
#define Pin_PullDown_HallEncoderB4_Pin GPIO_PIN_3
#define Pin_PullDown_HallEncoderB4_GPIO_Port GPIOB
...
#define Pin_Exti_HallEncoderA4_Pin GPIO_PIN_0
#define Pin_Exti_HallEncoderA4_GPIO_Port GPIOE
#define Pin_Exti_HallEncoderA4_EXTI_IRQn EXTI0_IRQn
